...
resource "google_container_node_pool" "battlesnake-k8s-np-02" {
  name       = "battlesnake-k8s-np-02"
  region     = "${var.region}"
  project    = "${var.project}"
  cluster    = "${google_container_cluster.battlesnake-k8s-gke.name}"
  node_count = 1
...
resource "google_container_node_pool" "battlesnake-k8s-np-03" {
  name       = "battlesnake-k8s-np-03"
  region     = "${var.region}"
  project    = "${var.project}"
  cluster    = "${google_container_cluster.battlesnake-k8s-gke.name}"
  node_count = 1
